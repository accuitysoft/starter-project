            ...
            <div className="timeline">
                <div class="timeline-entries">
                    <div class="timeline-entry">
                        <div class="timeline-title"><FontAwesomeIcon icon={faGraduationCap} /> <br></br> 2008 </div>
                    ...
                    <div class="timeline-entry-right">
                        <div class="timeline-title"><FontAwesomeIcon icon={faBalanceScale} /> <br></br> 2009</div>
                        <div class="timeline-body">
                            <p>Received Chartered Accountant designation and promoted to Senior Accountant</p>
                        </div>
                    </div>
                    <div class="timeline-entry">
                        <div class="timeline-title"><FontAwesomeIcon icon={faPlane} /> <br></br> 2011</div>
                        <div class="timeline-body">
                            <p>Flew to India to learn about the family business and experience life in a different country</p>
                        </div>
                    </div>
                    <div class="timeline-entry-right">
                        <div class="timeline-title"><FontAwesomeIcon icon={faReply} /> <br></br> 2012</div>
                        <div class="timeline-body">
                    ...
                    <div class="timeline-entry">
                        <div class="timeline-title"><FontAwesomeIcon icon={faHandshake} /> <br></br> 2015</div>
                        <div class="timeline-body">
                            <p>Promoted to Manager - led audit engagements of public companies with market cap between $70M and $500M.</p>
                        </div>
                    </div>
                    <div class="timeline-entry-right">
                        <div class="timeline-title"><FontAwesomeIcon icon={faWrench} /> <br></br> 2016</div>
                        <div class="timeline-body">
                            <p>Joined a construction company as Corporate Controller with 8 direct reports. Reported directly to CEO.</p>
                        </div>
                    </div>
                    <div class="timeline-entry">
                        <div class="timeline-title"><FontAwesomeIcon icon={faUsers} /> <br></br> 2019</div>
                        <div class="timeline-body">
